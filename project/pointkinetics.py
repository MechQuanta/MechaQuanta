class PointKineticsConstant:
	BETA_GROUPS = [0.00025,0.001424,0.001274,0.002568,0.000748,0.000273]
	LAMBDA_GROUPS = [0.0124,0.0305,0.111,0.301,1.14,3.01]
	N_GEN_TIME = 1e-3
	def __init__(self,beta_groups=BETA_GROUPS,lambda_groups=LAMBDA_GROUPS,n_gen_time = N_GEN_TIME):
